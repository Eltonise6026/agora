      ...
      <div className="bg-surface border border-border rounded-xl p-8 max-w-sm w-full text-center">
        ...
        <form method="POST" action="/api/auth/signin/github">
          ...
          <button
            type="submit"
            disabled={!csrfToken}
            className="w-full bg-[#e5e5e5] hover:bg-white disabled:opacity-50 text-[#0a0a0a] font-medium py-2.5 px-4 rounded-lg transition-colors flex items-center justify-center gap-2"
          >
